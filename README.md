...
**Gradle**
```
compile "io.tekniq:tekniq-core:0.10.0"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-cache:0.10.0"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-jdbc:0.10.0"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-rest:0.10.0"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-sparklin:0.10.0"
```
