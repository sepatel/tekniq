...
**Gradle**
```
compile "io.tekniq:tekniq-core:0.8"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-cache:0.8"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-jdbc:0.8"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-rest:0.8"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-sparklin:0.8"
```
