...
**Gradle**
```
compile "io.tekniq:tekniq-core:0.9.2"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-cache:0.9.2"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-jdbc:0.9.2"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-rest:0.9.2"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-sparklin:0.9.2"
```
