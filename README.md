...
**Gradle**
```
compile "io.tekniq:tekniq-core:0.7.1"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-cache:0.7.1"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-jdbc:0.7.1"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-rest:0.7.1"
```
...
**Gradle**
```
compile "io.tekniq:tekniq-sparklin:0.7.1"
```
